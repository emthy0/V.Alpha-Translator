...
def manga_tran(path,src_lang,lang):
    ix,iy = -1,-1
    count = 0
    check = 0
    ...
    def OCR():
        ...
        text_rec = pytesseract.image_to_string("textbox" + str(page_no) + ".jpg", lang=src_lang)
    ...
    def TRANS(destlang):
        ...
        global before_text
        global after_text
        translations = translator.translate(before_text.get("1.0", tk.END), dest=destlang)
    ...
    trans_but = tk.Button(trans, bg='#313131', fg='#ffffff', activebackground='#ffffff' ,activeforeground='#000000', font=('Courier', 18), text="Trans", command=TRANS(lang))
